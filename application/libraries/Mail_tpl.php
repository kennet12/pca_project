	...
	function booking($tpl_data)
	{
		...
		$content .= '</table>
			...
			$content .= '<tr>
					...
					<p style="margin: 10px 0;line-height: 20px;font-size: 14px;">Chúc bạn có một ngày mua sắm vui vẻ. Chúng tôi rất mong được được sự ủng hộ của bạn, bạn có thể mua thêm sản phẩm tại đây:</p>
					<div style="text-align: center;">
						<a href="'.site_url('san-pham').'" target="_blank" style="background: #fc5722;color: #fff;font-size: 22px;padding: 5px 15px;display: inline-block;margin: 8px 0;">Mua hàng</a>
					</div>';
