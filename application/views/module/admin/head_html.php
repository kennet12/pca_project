...
<link rel="stylesheet" type="text/css" media="screen,all" href="<?=ADMIN_CSS_URL?>bootstrap.min.css?cr=<?=CACHE_RAND?>" />
...
<script type="text/javascript" src="<?=ADMIN_JS_URL?>bootstrap.min.js?cr=<?=CACHE_RAND?>"></script>
