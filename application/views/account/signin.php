			...
			<div class="col-md-6">
				<form action="">
					<div class="box-register">
						<h3>PCA MEMBERSHIP FORM</h3><br><br>
						<input type="text" class="box-register-input" name="" id="" placeholder="*Fullname">
						<input type="text" class="box-register-input" name="" id="" placeholder="*Email">
						<input type="text" class="box-register-input" name="" id="" placeholder="*Mobile Number">
						<input type="text" class="box-register-input" name="" id="" placeholder="*Street Address">
						<input type="text" class="box-register-input" name="" id="" placeholder="Address line 2">
						<div class="row">
							<div class="col-md-6"><input type="text" class="box-register-input" name="" id="" placeholder="*City"></div>
							<div class="col-md-6"><input type="text" class="box-register-input" name="" id="" placeholder="*State"></div>
						</div>
						<div class="row">
							<div class="col-md-6"><input type="text" class="box-register-input" name="" id="" placeholder="*Postal / Zip Code"></div>
							<div class="col-md-6">
							<select class="box-register-input" name="country" style="padding:7px">
						...
						<hr color="gray">
						<input type="text" class="box-register-input" name="" id="" placeholder="*Fullname">
						<p><strong for="">*Have you previously been a member before?</strong></p>
