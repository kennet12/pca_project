                        ...
                        ?>
                           <div class="item item-product">
                              <div class="thumbnail-container has-multiimage has_variants">
                                 <a class="w-100" href="<?=site_url($related_products[$i]->{$prop['alias']})?>">
                                 ...
                                 <div class="group-buttons productWishList">
                                    ...
                                    $status = 0;
                                       $cls = 'removed-wishlist';
                                       if(!empty($user)) {
                                       if (strpos($user->like_product,'"'.$related_products[$i]->id.'"') !== false) {
                                          $status = 2;
                                          $cls = 'added-wishlist';
                                       } else 
                                          $status = 1;
                                    ...
                                    ?>
                                    <a status='<?=$status?>' id_item='<?=$related_products[$i]->id?>' class="<?=$cls?> btn btnProduct btnProductWishlist btnProductWishlist-<?=$related_products[$i]->id?>">
                              ...
                              <div class="product__info text-center">
                                 <div class="product__title">
                                    <a class="limit-content-1-line" href="<?=site_url($related_products[$i]->{$prop['alias']})?>"><?=$related_products[$i]->{$prop['title']}?></a>
                                 </div>
                                 ...
                                 <? } ?>
                                 <a class="btn btnAddToCart btnChooseVariant" href="<?=site_url($related_products[$i]->{$prop['alias']})?>">
