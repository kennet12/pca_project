...
<body style="color: #555;font-size: 15px;font-family: Arial,Tahoma,sans-serif;background: #eee;padding: 10px;">
    <div style="width: 21cm;margin: 15px auto;">
        <div style="color: #fc5722;display: table;width: 100%;background: #FFF;">
            ...
            <div style="display:table-cell;width:70%;padding: 15px;color:#fc5722;vertical-align:top;text-align:right">
        ...
        <div style="padding:0 15px 15px;background: #fff;">
            ...
            <table style="width: 100%;border-top: 1px solid #fc5722;margin-top: 40px;">
                <tr>
                    ...
                    <td style="width:25%;padding: 20px 10px;color: #fc5722;font-weight: bold;text-align:right;">
                        Thành tiền
                    </td>
                </tr>
                <?  
                ...
                <tr>
                    ...
                    <td style="width:50%">
                        ...
                        <table style="width: 100%;margin-top:30px;">
                            <tr>
                                <td style="width:20%;padding: 3px 10px;font-size: 14px;color: #fc5722;text-align:right;"></td>
